...
* Use the prompts and talking points (🔑) below to review the following key points:
  ...
  * ✔️ `const { MongoClient } = require('mongodb')`

  * ✔️ `mongodb://127.0.0.1:27017`

  * ✔️ `new MongoClient(connectionStringURI)`
...
* Open `04-Stu_Create-Read/Solved/server.js` in your IDE and explain the following:
  ...
  * 🔑 We instantiate a new instance of the MongoClient class.
  ...
  * We declare and assign a variable to hold our database name.
...
* Open `06-Stu_Update-Delete/Solved/server.js` in your IDE and explain the following:
  ...
  * Each MongoDB document is given a unique, 12-byte BSON type identifier. To access that identifier, we have to require the `ObjectId` class from `mongodb`.
