...
* Mongoose is an Object Data Modeling (ODM) library for MongoDB and Node.js. First, make sure that you first have both MongoDB and Node.js installed. We will be using Mongoose version `6.9.2`, as version 7+ potentially introduces breaking changes for our activities. For start-up instructions, refer to the [Mongoose docs on getting started](https://mongoosejs.com/docs/index.html#).
